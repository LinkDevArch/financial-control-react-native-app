...
export default function EditAccountScreen() {
  ...
  const initialName = params.accountName as string || '';
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (result.success) {
        ...
        const errorMessage = result.error?.join(', ') || 'Error al actualizar la cuenta';
  ...
  return (
    <SafeAreaView style={[styles.container, { paddingBottom: insets.bottom }]}>
      ...
      <Header title='Editar Cuenta' showBackButton={true} showConfig={false}/>
        ...
        >
          ...
          <View style={styles.form}>
            ...
            {hasChanges && (
              ...
              <Text style={styles.helpTitle}>💡 Consejos para editar cuentas:</Text>
